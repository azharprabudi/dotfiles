...
plugins=(ansible aws colorize command-not-found docker docker-compose encode64 fzf git history jsontools kubectl systemadmin terraform tmuxinator z zsh-autosuggestions zsh-syntax-highlighting)
